                                        ...
                                        <div className="bg-green-50/50 p-4 rounded-xl border border-green-100 flex flex-col gap-3">
                                            <div className="flex items-center justify-between">
                                                <div>
                                                    ...
                                                    <p className="text-xs text-green-700/60 leading-tight">Pay the remaining balance</p>
                                                </div>
                                                <div className="text-right">
                                                    <span className="text-[10px] text-gray-500 uppercase tracking-wider">Remaining</span>
                                                    <p className="text-sm font-bold text-gray-900">{(order.total_amount - order.deposit_value).toFixed(2)} DA</p>
                                                </div>
                                            </div>
                                            ...
                                            <div className="flex flex-col gap-2">
                                                <div className="flex items-center gap-3">
                                                    <button
                                                        ...
                                                        disabled={updatingOrderId === order.id || uploadingSecondReceipt}
                                                        className="w-full px-4 py-2 bg-green-600 text-white text-sm font-medium rounded-lg hover:bg-green-700 disabled:opacity-50 disabled:cursor-not-allowed transition-colors whitespace-nowrap flex items-center justify-center"
                                                    >
                                                        {updatingOrderId === order.id ? (
                                                            <div className="animate-spin rounded-full h-4 w-4 border-2 border-white border-t-transparent"></div>
                                                        ) : (
                                                            `Confirm Payment (${(order.total_amount - order.deposit_value).toFixed(2)} DA)`
                                                        )}
                                                    </button>
                                                </div>
