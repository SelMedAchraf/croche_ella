                                ...
                                <tr key={order.id} className="hover:bg-gray-50/50 transition-colors">
                                    ...
                                    <td className="px-6 py-4 text-center">
                                        {['pending', 'waiting_deposit'].includes(order.status) && !order.cancel_requested ? (
                                            <button
                                                ...
                                                className="inline-flex items-center justify-center gap-1 w-32 py-2 bg-red-50 text-red-600 hover:bg-red-100 hover:text-red-700 rounded-lg text-xs font-medium transition-colors border border-transparent hover:border-red-200"
                                                title="Cancel Order"
                                            >
                                            ...
                                            <button
                                                ...
                                                className="inline-flex items-center justify-center gap-1 w-32 py-2 bg-orange-50 text-orange-600 hover:bg-orange-100 hover:text-orange-700 rounded-lg text-xs font-medium transition-colors border border-transparent hover:border-orange-200"
                                    ...
                                    <td className="px-6 py-4 text-center">
                                        <button
                                            ...
                                            className="inline-flex items-center justify-center gap-2 px-4 py-2 bg-gray-50 text-primary border border-gray-200 hover:bg-primary hover:border-primary hover:text-white rounded-lg text-sm font-medium transition-colors"
                                        >
